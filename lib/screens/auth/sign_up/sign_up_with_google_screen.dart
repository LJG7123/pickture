...
class SignUpWithGoogleScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SignUpWithGoogleScreenState();
}

class _SignUpWithGoogleScreenState extends ConsumerState {
  final _pageNotifierProvider = ChangeNotifierProvider((ref) => PageNotifier(pageCount: 2));
          ...
          children: [
            Expanded(
              child: PageView(
                ...
                children: [
                  FirstPage(controller: _dobController),
                  SecondPage(controller: _nameController),
                ],
              ),
            ),
